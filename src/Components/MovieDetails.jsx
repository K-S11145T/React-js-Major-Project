...
const MovieDetails = () => {
  ...
  return info ? (
    ...
    <>
      <div className='w-[100%] min-h-[185vh]'>
        <div className='w-full relative h-full  bg-gradient-to-b from-zinc-900 to-black h-[50vh]'>
          ...
          <div className='absolute left-0 top-0  px-20' >
            <nav className='absolute py-5 flex items-center px-20 gap-5 text-base  top-0 left-0 w-full text-zinc-200'>
              <Link>
            ...
            <div>
              <div className='mt-20 w-full flex gap-12'>
                ...
                <div className='text-white w-[80%]'>
                  <h1 className='text-4xl font-black text-white'>
                    ...
                    <small className='font-bold text-zinc-200 text-lg'>({info.detail.release_date.split("-")[0]})</small>
                  </h1>
                  <div className='flex mt-2 text-white text-base items-center gap-5'>
                    ...
                    <h1 className='text-lg font-medium'>User Score</h1>
                  ...
                  <Link className='p-3 bg-blue-700 text-sm hover:bg-blue-800 rounded' to={`${pathname}/trailer`}> <i class="ri-play-fill"></i> Play Trailer </Link>
                </div>
              </div>
              ...
              <div className='w-[90vw] mt-7 px-auto '>
