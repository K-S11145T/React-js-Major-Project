...
const TvDetails = () => {
  ...
  return info ? (
    ...
    <>
      <div className='w-[100%] min-h-[215vh]'>
        <div className='w-full relative h-full  bg-gradient-to-b from-zinc-900 to-black h-[50vh]'>
          ...
          <div className='absolute left-0 top-0  px-20' >
            ...
            <div>
              <div className='mt-32 w-full flex gap-12'>
                ...
                <div className='text-white w-[80%]'>
                  <h1 className='text-5xl font-black text-white'>
                    ...
                    <small className='font-bold text-zinc-200 text-2xl'>({info.detail.first_air_date.split("-")[0]})</small>
                  </h1>
                  ...
                  <h1 className='text-xl mt-5'>tv Translated</h1>
              ...
              <div className='w-[90vw] min-h-[60vh] mb-5 mt-10 px-auto overflow-y-auto '>
                <div className='mb-3 flex justify-between'>
                  <h1 className='text-zinc-200 font-semibold text-2xl'>Seasons</h1>
                ...
                <div className='w-full gap-20 flex '>
                  ...
                  {info.detail.seasons.length > 0 ? info.detail.seasons.map((e, i) =>
                    ...
                    <h1 className=' h-[40vh] font-semibold w-[30vh] shrink-0  text-xl gflex flex-col items-start justify-evenly text-white '>
